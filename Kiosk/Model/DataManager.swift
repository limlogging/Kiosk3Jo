    ...
    init() {
        let macBook = [
            AppleProduct(image: UIImage(named: "MacBookAir13(M2)"), name: "MacBook Air13(M2)", price: 1390000, category: "맥북", value: 1, isNew: false),
                        AppleProduct(image: UIImage(named: "MacBookAir13(M3)"), name: "MacBook Air13(M3)", price: 1590000, category: "맥북", value: 1, isNew: true),
                        ...
                        AppleProduct(image: UIImage(named: "MacBookPro16"), name: "MacBook Pro16", price: 3690000, category: "맥북", value: 1, isNew: false),
                    ...
                    let iPhone = [
                        AppleProduct(image: UIImage(named: "iPhone15Pro"), name: "iPhone 15 Pro", price: 1550000, category: "아이폰", value: 1, isNew: true),
                        AppleProduct(image: UIImage(named: "iPhone15ProMax"), name: "iPhone 15 Pro Max", price: 1900000, category: "아이폰", value: 1, isNew: true),
                        AppleProduct(image: UIImage(named: "iPhone15"), name: "iPhone 15", price: 1250000, category: "아이폰", value: 1, isNew: true),
                        AppleProduct(image: UIImage(named: "iPhone15Plus"), name: "iPhone 15 Plus", price: 1350000, category: "아이폰", value: 1, isNew: true),
                        AppleProduct(image: UIImage(named: "iPhone14"), name: "iPhone 14", price: 1090000, category: "아이폰", value: 1, isNew: false),
                    ...
                    let etcAccessory = [
                        AppleProduct(image: UIImage(named: "MagSafeiPhone15SiliconeCase"), name: "MagSafe형 iPhone 15 실리콘 케이스", price: 69000, category: "악세사리", value: 1, isNew: true),
                        AppleProduct(image: UIImage(named: "MacSafeiPhone15ProClearCase"), name: "MagSafe형 iPhone 15 Pro 투명 케이스", price: 69000, category: "악세사리", value: 1, isNew: true),
                        AppleProduct(image: UIImage(named: "20WUSB-CpowerAdapter"), name: "20W USB-C 전원 어댑터", price: 28000, category: "악세사리", value: 1, isNew: false),
                        AppleProduct(image: UIImage(named: "MacSafeiPhoneFineWovenWallet"), name: "MagSafe형 iPhone 파인우븐 카드지갑", price: 85000, category: "악세사리", value: 1, isNew: false),
